...
public class UserMessageAdapterPages extends RecyclerView.Adapter<UserMessageAdapterPages.LinearViewHolder> {
    private Context context;
    private List<UserBeen.UserMessageDTO> userData;


    public UserMessageAdapterPages(Context context, List<UserBeen.UserMessageDTO> userData) {
